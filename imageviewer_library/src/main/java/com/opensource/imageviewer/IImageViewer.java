 ...
 *******************************************************************************/
package com.opensource.imageviewer;
...
public interface IImageViewer {
    ...
    /**
     * Returns true if the ImageViewer is set to allow zooming of Photos.
     *
     * @return true if the ImageViewer allows zooming.
     */
    boolean canZoom();
     ...
     *
     * @param finalMatrix target matrix to set ImageViewer to
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(ImageViewerAttacher.OnPhotoTapListener listener);

    /**
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @return ImageViewerAttacher.OnPhotoTapListener currently set, may be null
     */
    ImageViewerAttacher.OnPhotoTapListener getOnPhotoTapListener();
    ...
    /**
     * Enables rotation via ImageViewer internal functions.
     *
     * @param rotationDegree - Degree to rotate ImageViewer to, should be in range 0 to 360
     */
     ...
     * Enables rotation via ImageViewer internal functions.
     *
     * @param rotationDegree - Degree to rotate ImageViewer by, should be in range 0 to 360
     */
     ...
     *
     * @return ImageViewerAttacher.OnViewTapListener currently set, may be null
     */
    ...
    /**
     * Enables rotation via ImageViewer internal functions. Name is chosen so it won't collide with
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (ImageViewerAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IImageViewer (eg. ImageViewerAttacher), can be used to provide better
     * integration
     *
     * @return IImageViewer implementation instance if available, null if not
     */
    IImageViewer getIPhotoViewImplementation();

    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to
     * default, you can just pass in "null" or public field of ImageViewerAttacher.defaultOnDoubleTapListener
     *
