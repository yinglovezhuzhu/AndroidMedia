...
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    private ImageViewerAttacher photoViewAttacher;

    /**
     * Default constructor
     *
     * @param photoViewAttacher ImageViewerAttacher to bind to
     */
    ...
    /**
     * Allows to change ImageViewerAttacher within range of single instance
     *
     * @param newPhotoViewAttacher ImageViewerAttacher to bind to
     */
