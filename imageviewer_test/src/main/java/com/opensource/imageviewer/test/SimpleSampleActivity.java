...
import com.opensource.imageviewer.ImageViewerAttacher;
...
public class SimpleSampleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAttacher = new ImageViewerAttacher(mImageView);
    ...
    private class PhotoTapListener implements ImageViewerAttacher.OnPhotoTapListener {
    ...
    private class MatrixChangeListener implements ImageViewerAttacher.OnMatrixChangedListener {
