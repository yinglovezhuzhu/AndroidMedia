...
public class MovieApp {
	static private final HashMap<Context, MovieApp> mMap = new HashMap<Context, MovieApp>();
		
	static public MovieApp get(Context context) {
	...
	public MovieApp(Context context) {
		// register
